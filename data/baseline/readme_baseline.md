...
These four files are sufficient to reproduce simple binned-spectrum comparisons and quick CMB sanity tests (e.g., plotting binned C_ℓ vs a theory curve) without running a full likelihood.
