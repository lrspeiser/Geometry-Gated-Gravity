...
from core.path_spectrum_kernel import PathSpectrumKernel, PathSpectrumHyperparams
from scripts.outlier_triage_analysis import OutlierTriageAnalyzer
...
def main():
    ...
    output_dir = repo_root / "results" / "track2_vs_track3_comparison"
